## seja bem-vindo ao meu projeto mongodb-commerce

## sobre o projeto
O mongodb-commerce é um projeto onde eu coloco em prática os conhecimentos ensinados pela Trybe em mongodb. No mongodb-commerce eu construo querys em cima do banco
de dados commerce, que contém dados do cardápio do McDonald's, como ingredientes, valores nutricionais e dados fictícios de vendas.
